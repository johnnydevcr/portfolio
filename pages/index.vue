<template>
  <div
    id="container"
    class="flex flex-col items-center lg:flex-row lg:justify-between lg:items-start"
  >
    <section
      id="information"
      class="lg:w-3/5"
    >
      ...
      <ul>
        ...
        <li class="font-bold">Phone Number: <span class="font-normal text-sm">+506 8747-3361</span></li>
